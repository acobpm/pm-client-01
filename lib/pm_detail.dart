    ...
    new BottomNavigationBar(
              ...
              items: [
                new BottomNavigationBarItem(
                  ...
                  title: new Text('Promise',style: _biggerFont,),
                ),
                new BottomNavigationBarItem(
                  icon: new Icon(Icons.account_balance_wallet),
                  title: new Text('Wallet',style: _biggerFont,),
                ),
                 new BottomNavigationBarItem(
                  icon: new Icon(Icons.report),
                  title: new Text('Stats',style: _biggerFont,),
                ),
        ...
        children: <Widget>[
          ...
          ,)   
            ...
            _buildPartnerItem(String partnerType,String partnerId){
              ...
              switch (partnerType) {
                case "Creator" :
                  icon = const Icon(Icons.person_pin,size:64.0,color: Colors.blue, );
                  break;
                case "From" :
                  icon = const Icon(Icons.account_box,size:64.0 ,color: Colors.red);
                  break;
                case "To" :
                  icon = const Icon(Icons.account_circle,size:64.0 ,color: Colors.green,);
                  break;
                default:
              }
            ...
            Icon _getMood(Duration d){
                  if (d!=null){
                    ...
                    var hours = d.inHours; 
                    if (hours >24){
                      return const Icon(Icons.sentiment_very_satisfied, color:Colors.greenAccent);
                    } else if (hours >0) {
                          ...
                          child: new Row(
                            ...
                            new Expanded(                  
                              child: new Container(                    
                                ...
                                child: new Text('${item.title}', textAlign: TextAlign.left, style: _textFont),                  
                              )
                            ),
                            new SizedBox(
                                height: 90.0,
                                  ...
                                  children: <Widget>[
                                      new Row(
                                        ...
                                        children: <Widget>[
                                            ...
                                            new Text(convertString(d), textAlign: TextAlign.left, style: _smallFont),
                                        ],
                                    ),
                                    new Row(
                                        mainAxisSize:MainAxisSize.max,                            
                                        children: <Widget>[
                                            const Icon(Icons.loyalty, color: Colors.redAccent,),
                                            new Text(' ${item.loveRate}', textAlign: TextAlign.left, style: _smallFont,),
                                            const Icon(Icons.attach_money,color: Colors.greenAccent),
                                            new Text('${item.bonus}', textAlign: TextAlign.left, style: _smallFont),
                                        ],
                                    ),
                                    new Row(
                                        mainAxisSize:MainAxisSize.max,                            
                                        children: <Widget>[
                                            const Icon(Icons.question_answer,color: Colors.brown),
                                            new Text(' ${item.status}', textAlign: TextAlign.left, style: _smallFont),
                                        ],
                                    ),
      ...
      child: new Container(
        ...
        children: <Widget>[ 
          new Align(
            ...
            child: new Row(              
              children: <Widget>[
                new Icon (Icons.email,color: Colors.brown,),
           ...
           new RaisedButton(            
            ...
            child: new Row(
              children: <Widget>[
                ...
                new Text("   BAD",style: _buttonTextFont,)  
              ],
           ...
           new RaisedButton(            
            ...
            child: new Row(
              children: <Widget>[
                ...
                new Text("   PASS",style: _buttonTextFont,)  
              ],
